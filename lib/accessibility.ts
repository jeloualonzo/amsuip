...
declare global {
  ...
  namespace JSX {
    interface IntrinsicElements {
      'visually-hidden': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
      'skip-link': React.DetailedHTMLProps<React.AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>;
    }
  }
}
